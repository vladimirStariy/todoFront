...
export const DeleteIcon: FC<IDeleteIcon> = (props) => {
    return <div onClick={props.onPress}>
        <svg style={{cursor: 'pointer'}} fill="#000000" width="24px" height="24px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
